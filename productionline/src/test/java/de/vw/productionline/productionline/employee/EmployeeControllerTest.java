...
public class EmployeeControllerTest {
     ...
     * employeeController.getAllEmployeesWithoutStation();
     * 
     * // then
     ...
     * employeeController.createEmployee(validEmployee);
     * 
     * // then
     ...
     * Assert.isTrue(savedValidEmployee.getName().equals("MR X"),
     * "validEmployee name should match");
     * Assert.isNull(savedValidEmployee.getStation(),
     * "validEmployee station should be null");
     * }
     * 
     * @Test
